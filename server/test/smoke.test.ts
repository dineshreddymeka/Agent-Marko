...
describe('schema module', () => {
  test('exports all planned tables', async () => {
    ...
    expect(schema.mcpConnectionEvents).toBeDefined()
    ...
    expect(schema.jarvisIndexDocuments).toBeDefined()
    expect(schema.jarvisIndexChunks).toBeDefined()
    expect(schema.jarvisIndexActions).toBeDefined()
    expect(schema.jarvisIndexActionLinks).toBeDefined()
    expect(schema.indexJobs).toBeDefined()
  })
})
