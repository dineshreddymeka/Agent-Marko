...
export const schemas: Record<string, JsonSchema> = {
  ...
  HealthResponse: {
    ...
    properties: {
      ...
      llm: {
        type: 'object',
        description: 'Public LLM mode only — baseUrl is on authenticated GET /api/debug/health',
        properties: {
          mode: { type: 'string', enum: ['mock', 'live'] },
          mock: { type: 'boolean' },
          model: { type: ['string', 'null'] },
        },
        required: ['mode', 'mock', 'model'],
      },
  ...
  IndexerPruneResponse: {
    type: 'object',
    properties: {
      jobs: { type: 'integer' },
      documents: { type: 'integer' },
    },
    required: ['jobs', 'documents'],
  },
  JarvisIndexDocument: {
  ...
  CapabilitiesResponse: {
    ...
    required: ['tools', 'skills', 'plugins', 'slashCommands', 'providers', 'routing', 'agentLlm'],
  },
